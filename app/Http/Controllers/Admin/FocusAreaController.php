...
{
    public function storeFromAdminPage(Request $request): JsonResponse
    {
    ...
    public function updateFromAdminPage(Request $request, FocusArea $focusArea): JsonResponse
    {
        $validated = $request->validate([
            'title' => ['required', 'string', 'max:200'],
            'description' => ['required', 'string'],
    ...
    public function destroyFromAdminPage(FocusArea $focusArea): JsonResponse
    {
