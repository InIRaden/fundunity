            ...
            <div class="flex flex-col items-center gap-16 md:flex-row">
                <div class="relative w-full md:w-1/2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <img src="<?php echo e($primaryImage); ?>" alt="Tentang FundUnity" class="h-64 w-full translate-y-8 rounded-3xl object-cover object-center shadow-lg">
                        <img src="<?php echo e($secondaryImage); ?>" alt="Tim FundUnity" class="h-64 w-full rounded-3xl object-cover object-center shadow-lg">
                    </div>
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <p class="mb-8 text-lg leading-relaxed text-slate-600">
                        <?php echo e(optional($page)->story_content ?? 'Kami adalah organisasi sosial yang membangun gerakan solutif bernilai tinggi, transparan, serta berdampak nyata bagi masyarakat luas.'); ?>
                    ...
                    <div data-about-panel="vision" class="about-tab-panel min-h-[150px] space-y-4">
                        <div class="flex gap-4">
                            ...
                            <div>
                                <h4 class="mb-1 font-bold text-slate-800"><?php echo e($visionItem?->title ?? (optional($page)->vision_title ?? 'Visi Kami')); ?></h4>
                                <p class="text-sm leading-relaxed text-slate-500">
                                    <?php echo e($visionItem?->description ?? (optional($page)->vision_content ?? 'Menjadi jembatan kebaikan digital yang transparan dan dapat diandalkan oleh masyarakat luas.')); ?>
                        ...
                        <div class="flex gap-4">
                            <i class="ph ph-check-circle mt-0.5 shrink-0 text-2xl text-emerald-500"></i>
                            <div>
                                <h4 class="mb-1 font-bold text-slate-800"><?php echo e($missionItem?->title ?? (optional($page)->mission_title ?? 'Misi Utama')); ?></h4>
                                <p class="text-sm leading-relaxed text-slate-500">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $teamPreview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center gap-3 rounded-xl border border-slate-100 bg-white p-4">
                                    <div class="h-12 w-12 shrink-0 overflow-hidden rounded-full border-2 border-emerald-100 bg-slate-50">
                                        <img src="<?php echo e($member->image_url ?: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop'); ?>" alt="<?php echo e($member->title); ?>" class="h-full w-full object-cover">
                                    </div>
                                    <div>
                                        <p class="about-clamp-1 text-sm font-bold text-slate-900"><?php echo e($member->title); ?></p>
                                        <p class="text-[10px] font-bold uppercase text-emerald-600"><?php echo e($member->position ?? 'Tim Organisasi'); ?></p>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Magang\PT. YMP\fundunity\resources\views\landing\about.blade.php ENDPATH**/ ?>