      ...
      <div class="bg-white rounded-2xl shadow-xl shadow-slate-200/30 border border-slate-100 p-8">
        ...
        <form id="pembayaranPane" class="hidden setting-pane space-y-8 animate-fade-in">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-2">
            <div class="space-y-5">
              <div><label class="block text-xs font-bold text-slate-500 mb-1.5 uppercase">Nama Bank</label><input id="bankName" type="text" value="<?php echo e($payment['bankName'] ?? ''); ?>" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm" required></div>
              <div><label class="block text-xs font-bold text-slate-500 mb-1.5 uppercase">Nomor Rekening</label><input id="bankAccount" type="text" value="<?php echo e($payment['bankAccount'] ?? ''); ?>" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold" required></div>
              <div><label class="block text-xs font-bold text-slate-500 mb-1.5 uppercase">Atas Nama</label><input id="bankHolder" type="text" value="<?php echo e($payment['bankHolder'] ?? ''); ?>" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm" required></div>
            </div>
            <div class="space-y-4">
        ...
        <form id="seoPane" class="hidden setting-pane space-y-8 animate-fade-in">
          ...
          <div class="space-y-5">
            <div><label class="block text-xs font-bold text-slate-500 mb-1.5 uppercase">Meta Description (SEO)</label><textarea id="seoMetaDescription" rows="2" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm"><?php echo e($seo['metaDescription'] ?? ''); ?></textarea></div>
            <div><label class="block text-xs font-bold text-slate-500 mb-1.5 uppercase">Copyright Text Footer</label><input id="seoFooterCopyright" type="text" value="<?php echo e($seo['footerCopyright'] ?? ''); ?>" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm"></div>
