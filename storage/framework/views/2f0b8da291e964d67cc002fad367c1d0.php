        ...
        <div class="overflow-hidden rounded-3xl border border-slate-100 bg-white p-6 shadow-2xl sm:p-10">
            ...
            <?php else: ?>
                <div class="animate-fade-in py-8 text-center">
                    ...
                    <a href="<?php echo e(route('programs')); ?>" class="rounded-xl bg-slate-900 px-8 py-3 font-bold text-white shadow-lg shadow-slate-900/20 transition-all hover:bg-slate-800">
                        Kembali ke Program
                    </a>
                </div>
            <?php endif; ?>
