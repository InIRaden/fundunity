...
<section class="relative flex min-h-screen items-center overflow-hidden bg-slate-900 pb-20 pt-24">
    ...
    <div class="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 text-center">
        ...
        <h1 class="mb-8 max-w-4xl text-5xl font-extrabold leading-tight tracking-tight text-white md:text-7xl">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <?php
                    $fallbackPartners = [
                        ...
                        ['name' => 'Yayasan Bersama', 'logo' => 'images/partners/partner3.png'],
                        ['name' => 'Relawan Nusantara', 'logo' => 'images/partners/partner4.png'],
...
<section class="bg-white px-6 py-20">
    <div class="container relative mx-auto max-w-4xl overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 to-emerald-800 p-8 text-center text-white shadow-xl md:p-12">
        <div class="absolute left-0 top-0 h-32 w-32 -translate-x-12 -translate-y-12 rounded-full bg-white/5"></div>
        <div class="absolute bottom-0 right-0 h-40 w-40 translate-x-12 translate-y-12 rounded-full bg-white/5"></div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        contactForm?.addEventListener('submit', function () {
            ...
            submitIcon.classList.add('ph-spinner', 'animate-spin');
        });
    });
</script>
<?php $__env->stopPush(); ?>
