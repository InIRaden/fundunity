      ...
      <div class="max-w-7xl mx-auto px-6 relative z-10">
        <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 mb-20">
          ...
          <div class="w-full lg:w-1/2">
            ...
            <h2 class="text-2xl md:text-4xl font-black text-slate-900 leading-[1.3] mb-6">
              <?php echo e($siteSettings['hero_title'] ?? 'Mewujudkan Dampak Yang Terukur & Nyata.'); ?>

            </h2>

            <p class="text-slate-600 text-base md:text-lg leading-relaxed mb-10">
              <?php echo e($siteSettings['hero_subtitle'] ?? 'Kami bukan sekadar wadah, tapi sebuah gerakan transformatif yang mengedepankan akuntabilitas digital untuk memberdayakan setiap lapisan masyarakat.'); ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-8">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3">
                            <div class="w-2.5 h-2.5 rounded-full bg-emerald-500 shrink-0 mt-2 shadow-sm"></div>
                            <p class="text-slate-700 text-sm font-semibold leading-relaxed"><?php echo e(preg_replace('/^\d+[\.\)]\s*/', '', $misi)); ?></p>
                        </div>
        ...
        <div class="bg-slate-50 rounded-[40px] p-8 md:p-12 mb-24 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-200/60 border border-slate-100 shadow-xl shadow-slate-200/40 relative overflow-hidden">
           ...
           <div class="text-center px-4 relative z-10">
               <p class="text-3xl md:text-4xl font-black text-emerald-600 mb-2"><?php echo e(number_format($impactStats['donor_count'] ?? 0, 0, ',', '.')); ?>+</p>
               <p class="text-slate-600 font-medium text-sm">Donatur Aktif</p>
           </div>
           <div class="text-center px-4 relative z-10">
               <p class="text-3xl md:text-4xl font-black text-emerald-600 mb-2"><?php echo e(number_format($impactStats['completed_programs'] ?? 0, 0, ',', '.')); ?>+</p>
               <p class="text-slate-600 font-medium text-sm">Program Selesai</p>
           </div>
           <div class="text-center px-4 relative z-10">
               <p class="text-3xl md:text-4xl font-black text-emerald-600 mb-2"><?php echo e($formatCompactRupiah($impactStats['distributed_amount'] ?? 0)); ?>+</p>
           ...
           <div class="text-center px-4 relative z-10 border-none md:border-l">
               <p class="text-3xl md:text-4xl font-black text-emerald-600 mb-2"><?php echo e(number_format($impactStats['volunteer_count'] ?? 0, 0, ',', '.')); ?>+</p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.person-circle','data' => ['class' => 'h-8 w-8 text-emerald-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\kuliah\lain lain\Magang\YMP\iniraden_fundunity\resources\views/landing/about.blade.php ENDPATH**/ ?>