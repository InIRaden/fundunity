      ...
      <form id="legalForm" class="space-y-8">
        ...
        <div class="space-y-4 pb-8 border-b border-slate-100">
          <div>
            ...
            <textarea id="privacyPolicy" name="privacyPolicy" rows="10" placeholder="Masukkan Kebijakan Privasi lengkap..." class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm font-mono outline-none focus:ring-2 focus:ring-emerald-500/20 resize-none transition-all"><?php echo e($legal['privacyPolicy'] ?? ''); ?></textarea>
            <p class="mt-2 text-xs text-slate-400 flex items-center gap-2">
              <i class="ph ph-info text-base"></i>
              <span>Ditampilkan di halaman <a href="<?php echo e(route('privacy')); ?>" target="_blank" class="text-emerald-600 hover:underline font-semibold">/privacy</a></span>
            </p>
          </div>
        </div>
        ...
        <div class="space-y-4">
          <div>
            ...
            <textarea id="termsConditions" name="termsConditions" rows="10" placeholder="Masukkan Syarat & Ketentuan lengkap..." class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm font-mono outline-none focus:ring-2 focus:ring-emerald-500/20 resize-none transition-all"><?php echo e($legal['termsConditions'] ?? ''); ?></textarea>
            <p class="mt-2 text-xs text-slate-400 flex items-center gap-2">
              <i class="ph ph-info text-base"></i>
              <span>Ditampilkan di halaman <a href="<?php echo e(route('terms')); ?>" target="_blank" class="text-emerald-600 hover:underline font-semibold">/terms</a></span>
            </p>
          </div>
        </div>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\kuliah\lain lain\Magang\YMP\iniraden_fundunity\resources\views/admin/legal.blade.php ENDPATH**/ ?>