      ...
      <div class="p-8">
        <div id="aboutDisplay" class="flex flex-col md:flex-row gap-12">
           ...
           <div class="w-full md:w-5/12 space-y-4">
              ...
              <div class="p-4 bg-admin-50 rounded-2xl border border-admin-100">
                <div class="flex gap-3">
                  <i class="ph ph-info text-admin-600 text-xl mt-0.5"></i>
                  <p class="text-xs text-admin-800 leading-relaxed font-medium">
           ...
           <div class="flex-1 space-y-6">
              <div class="flex items-center justify-between">
                 ...
                 <button id="btnEditAbout" class="flex items-center gap-2 px-5 py-2.5 bg-admin-600 text-white rounded-xl text-sm font-bold hover:bg-admin-700 transition-all shadow-lg shadow-admin-600/20">
...
<div id="aboutEditModal" class="hidden fixed inset-0 z-[100] items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm overflow-y-auto">
  <div class="bg-white rounded-3xl w-full max-w-lg flex flex-col max-h-[90vh] my-auto shadow-2xl animate-slide-up overflow-hidden">
    <div class="flex items-center justify-between px-6 py-4 border-b border-slate-100">
      <h3 id="editModalTitle" class="text-base font-bold text-admin-700">Edit Konten</h3>
    ...
    <form id="aboutEditForm" class="flex flex-col flex-1 overflow-hidden">
      <div class="p-6 space-y-4 overflow-y-auto flex-1">
        ...
        <div>
          ...
          <textarea id="editDesc" rows="6" required class="w-full border border-slate-200 rounded-xl px-4 py-2 bg-slate-50 text-sm focus:border-admin-500 outline-none"></textarea>
        </div>
        <div>
      ...
      <div class="p-5 bg-slate-50 border-t border-slate-100 flex justify-end gap-3 rounded-b-3xl shrink-0">
        ...
        <button id="submitEditAbout" type="submit" class="px-6 py-2 bg-admin-600 text-white font-bold rounded-xl text-sm shadow-md hover:bg-admin-700 flex items-center gap-2 min-w-[140px] justify-center transition-all">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\kuliah\lain lain\Magang\YMP\iniraden_fundunity\resources\views/admin/aboutus.blade.php ENDPATH**/ ?>