    ...
    <div class="mx-auto max-w-7xl px-6">
        <div class="mb-16 grid grid-cols-1 gap-12 md:grid-cols-12 lg:gap-8">
            ...
            <div class="md:col-span-2">
                ...
                <ul class="space-y-4">
                    <li><a href="<?php echo e(route('landing.about')); ?>" class="transition-colors hover:text-emerald-400">Tentang Kami</a></li>
                    <li><a href="<?php echo e(route('landing.about')); ?>" class="transition-colors hover:text-emerald-400">Visi & Misi</a></li>
                    <li><a href="<?php echo e(route('landing.faq')); ?>" class="transition-colors hover:text-emerald-400">FAQ</a></li>
                    <li><a href="<?php echo e(route('landing.get-involved')); ?>" class="transition-colors hover:text-emerald-400">Karir & Relawan</a></li>
                </ul>
            </div>
            ...
            <div class="md:col-span-3">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span><?php echo e($siteSettings['address'] ?? 'Sekretariat Utama, Gedung Kemahasiswaan Lt. 2, Jatinangor'); ?></span>
                    </li>
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <span><?php echo e($siteSettings['email'] ?? 'yukmari@ymp.ac.id'); ?></span>
                    </li>
                </ul>
            </div>
        ...
        <div class="flex flex-col items-center justify-between gap-4 border-t border-slate-800 pt-8 text-sm md:flex-row">
            <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($siteSettings['footer_copyright'] ?? 'Yuk Mari Project. All rights reserved.'); ?></p>
