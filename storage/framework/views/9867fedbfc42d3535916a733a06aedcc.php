    ...
    <section id="pilar" class="bg-white py-24">
        <div class="mx-auto max-w-7xl px-6">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                <?php $__empty_1 = true; $__currentLoopData = $displayPillars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pillar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="flex h-full flex-col bg-white p-8 md:p-10 rounded-[40px] shadow-xl shadow-slate-200/50 border border-slate-100 hover:-translate-y-2 transition-transform duration-300">
                        <div class="mb-5 text-[40px] <?php echo e($pillar['style']); ?>">
                            <i class="<?php echo e($pillar['icon']); ?>"></i>
                        </div>
                        <h3 class="text-xl font-bold text-slate-900 mb-4"><?php echo e($pillar['title']); ?></h3>
                        <p class="text-slate-600 leading-relaxed flex-1"><?php echo e($pillar['description']); ?></p>
                    </article>
    ...
    <section class="bg-[#022c22] py-24 relative overflow-hidden">
        ...
        <div class="mx-auto max-w-7xl px-6 relative z-10">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center">
                ...
                <div>
                    <div class="text-5xl md:text-6xl font-black text-white mb-2"><?php echo e($labelActiveCampaign); ?><span class="text-orange-400">+</span></div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\coding\fundunity\resources\views/landing/focus-areas.blade.php ENDPATH**/ ?>