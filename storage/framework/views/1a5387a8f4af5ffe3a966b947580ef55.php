  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
    <div class="bg-gradient-to-br from-admin-600 to-admin-800 rounded-2xl p-6 text-white shadow-xl shadow-admin-600/20 relative overflow-hidden group">
      <div class="relative z-10 flex flex-col h-full justify-between">
        ...
        <div class="mt-4 flex items-center gap-2 text-sm <?php echo e($incomeTrendStatus === 'up' ? 'text-admin-50 bg-white/10' : 'text-amber-100 bg-amber-500/20'); ?> px-3 py-1.5 rounded-lg w-fit backdrop-blur-sm">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal','data' => ['id' => 'incomeModal','title' => 'Input Manual Donasi','maxWidth' => 'max-w-lg','headerColor' => 'bg-admin-600','closeButtonId' => 'closeIncomeModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'incomeModal','title' => 'Input Manual Donasi','maxWidth' => 'max-w-lg','headerColor' => 'bg-admin-600','closeButtonId' => 'closeIncomeModal']); ?>
...
<?php if (isset($component)) { $__componentOriginal883972b03e56cea0994a1aaccc5761f0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal883972b03e56cea0994a1aaccc5761f0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal','data' => ['id' => 'detailModal','title' => 'Detail Program','maxWidth' => 'max-w-2xl','headerColor' => 'bg-admin-600','closeButtonId' => 'closeDetailModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'detailModal','title' => 'Detail Program','maxWidth' => 'max-w-2xl','headerColor' => 'bg-admin-600','closeButtonId' => 'closeDetailModal']); ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\kuliah\lain lain\Magang\YMP\iniraden_fundunity\resources\views/admin/keuangantransparansi.blade.php ENDPATH**/ ?>