...
>
    <div class="mx-auto flex max-w-7xl items-center justify-between px-6">
        ...
        <nav class="hidden items-center gap-6 xl:gap-8 lg:flex">
            <a href="<?php echo e(route('home')); ?>" class="landing-nav-link <?php echo e($isLandingHome ? 'text-white/80 hover:text-white' : 'text-slate-600 hover:text-emerald-600'); ?> text-sm font-bold transition-colors">
                Beranda
            </a>
        ...
        <div class="hidden items-center gap-4 lg:flex">
            <a href="<?php echo e(route('donation.form')); ?>" class="rounded-full bg-emerald-500 px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-emerald-500/20 transition-colors hover:bg-emerald-600">
                Donasi Sekarang
            </a>
        </div>
    ...
    <div id="landingMobileMenu" class="absolute left-0 top-full hidden w-full border-b border-slate-100 bg-white shadow-2xl lg:hidden">
        <div class="flex max-h-[85vh] flex-col gap-6 overflow-y-auto p-6">
            <a href="<?php echo e(route('home')); ?>" class="text-lg font-extrabold text-slate-900">Beranda</a>
            ...
            <div class="border-t border-slate-100 pt-6">
                <a href="<?php echo e(route('donation.form')); ?>" class="block w-full rounded-2xl bg-emerald-500 py-3 text-center text-sm font-bold text-white shadow-lg shadow-emerald-500/20">
                    Donasi Sekarang
                </a>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\Magang\PT. YMP\fundunity\resources\views\components\landing\navbar.blade.php ENDPATH**/ ?>