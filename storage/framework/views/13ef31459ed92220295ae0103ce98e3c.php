            ...
            <form method="POST" action="<?php echo e(route('get-involved.store')); ?>" class="md:w-7/12 p-10 flex flex-col gap-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" required value="<?php echo e(old('name')); ?>" placeholder="Cth: Budi Santoso" class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-emerald-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 outline-none text-sm transition-all text-slate-800">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" required value="<?php echo e(old('email')); ?>" placeholder="budi@email.com" class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-emerald-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 outline-none text-sm transition-all text-slate-800">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="phone" required value="<?php echo e(old('phone')); ?>" placeholder="+62 8..." class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-emerald-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 outline-none text-sm transition-all text-slate-800">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="message" rows="3" placeholder="Ceritakan motivasi atau keahlian spesifik Anda..." class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-emerald-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 outline-none text-sm transition-all text-slate-800 resize-none"><?php echo e(old('message')); ?></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\coding\intern yukmari\fundunity\resources\views/landing/get-involved.blade.php ENDPATH**/ ?>