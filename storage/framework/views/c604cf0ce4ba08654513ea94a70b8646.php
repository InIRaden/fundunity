...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.person-circle','data' => ['class' => 'h-6 w-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div>
                    ...
                    <p class="text-lg font-extrabold text-slate-900 leading-tight"><?php echo e($activeCampaign->title); ?></p>
                </div>
            </div>
        <?php else: ?>
                    ...
                    <div id="donationResumePrompt" class="mb-6 hidden rounded-xl border border-amber-200 bg-amber-50 p-4">
                        <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
                            <div class="flex items-center gap-3">
                                <?php if (isset($component)) { $__componentOriginal2a408760c50f134c49145997aa7ece00 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2a408760c50f134c49145997aa7ece00 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.person-circle','data' => ['class' => 'h-6 w-6 text-amber-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icons.person-circle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-6 w-6 text-amber-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2a408760c50f134c49145997aa7ece00)): ?>
<?php $attributes = $__attributesOriginal2a408760c50f134c49145997aa7ece00; ?>
                    ...
                    <div class="mb-8 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="donationEmailInput" type="text" value="<?php echo e(old('email')); ?>" placeholder="Email atau No WA (untuk bukti donasi)" class="w-full rounded-xl border-2 border-slate-100 bg-slate-50 py-3 pl-12 pr-4 font-bold text-slate-900 outline-none transition-colors focus:border-emerald-500">
                            </div>
                ...
                <div data-step-panel="3" class="hidden text-center">
                    <div class="mb-6 flex items-start justify-between text-left">
                        ...
                        <div class="flex shrink-0 items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-1.5 text-amber-600">
                            <?php if (isset($component)) { $__componentOriginal2a408760c50f134c49145997aa7ece00 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2a408760c50f134c49145997aa7ece00 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.person-circle','data' => ['class' => 'h-4 w-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icons.person-circle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                    ...
                    <div class="mb-8 inline-block rounded-3xl border-2 border-slate-100 bg-white p-8 shadow-2xl shadow-slate-200/50">
                        <div class="relative mx-auto mb-3 flex h-56 w-56 items-center justify-center overflow-hidden rounded-2xl border-4 border-slate-50 bg-slate-50">
                            <?php if(!empty($qrisUrl)): ?>
                                <img src="<?php echo e($qrisUrl); ?>" alt="QRIS Code" class="w-full h-full object-contain">
                            <?php else: ?>
            ...
            <?php else: ?>
                <div class="animate-fade-in text-center py-8">
                    ...
                    <h2 class="text-3xl font-extrabold text-slate-900 mb-2">Terima Kasih, <?php echo e(session('donation_name', 'Sahabat Kebaikan')); ?>!</h2>
                    <p class="text-slate-500 mb-6 max-w-sm mx-auto leading-relaxed">
                        Donasi Anda sebesar <span class="font-bold text-slate-700">Rp <?php echo e(number_format((int) session('donation_amount', 0), 0, ',', '.')); ?></span> telah berhasil diverifikasi.
                    </p>
                    ...
                    <div class="bg-slate-50 rounded-2xl p-6 mb-8 border border-slate-100 text-left">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-slate-700"><?php echo e(session('donation_transaction', 'DON-LOCAL')); ?></span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-slate-700"><?php echo e(now()->format('d/m/Y H:i')); ?></span>
                            </div>
                        </div>
                        <div class="mt-4 pt-4 border-t border-slate-200 text-xs text-slate-500">
                            Tanda terima dan link live tracking program telah dikirim ke <b><?php echo e(session('donation_email', 'email Anda')); ?></b>. Terima kasih atas kepedulian Anda.
                        </div>
                    </div>

                    <a href="<?php echo e(route('landing.programs')); ?>" class="px-8 py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl transition-all shadow-lg shadow-slate-900/20">
                        Kembali ke Beranda
                    </a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\kuliah\lain lain\Magang\YMP\iniraden_fundunity\resources\views/landing/donation.blade.php ENDPATH**/ ?>