...
<script>
  const sliderState = { items: <?php echo json_encode($sliderItems, 15, 512) ?>, search: '', editingId: null, deletingId: null };
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Magang\PT. YMP\fundunity\resources\views/admin/imageslider.blade.php ENDPATH**/ ?>