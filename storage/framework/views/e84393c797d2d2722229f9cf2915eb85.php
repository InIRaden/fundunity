...
<?php endif; ?>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-black">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="<?php echo e(route('donation.form')); ?>" data-donation-trigger="modal" class="block px-3 py-2 bg-blue-600 text-white rounded-lg"><?php echo e($siteSettings['nav_donate_button_text'] ?? 'Donasi Sekarang'); ?></a>
        </div>
    </div>
</nav>
