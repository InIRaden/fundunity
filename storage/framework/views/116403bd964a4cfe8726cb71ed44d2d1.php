...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="mb-16">
                <h2 class="text-2xl font-bold mb-8"><?php echo e($section['title']); ?></h2>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                    <?php $__empty_1 = true; $__currentLoopData = $partnersInSection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-gray-50 rounded-lg p-6 flex flex-col items-center justify-center aspect-square hover:shadow-lg transition border border-slate-100">
                            <?php if(!empty($partner->logo)): ?>
                                <img src="<?php echo e($partner->logo); ?>" alt="<?php echo e($partner->name); ?>" class="max-h-20 w-auto object-contain">
                            <?php else: ?>
                                <div class="text-center text-gray-400 text-sm font-semibold">Logo Mitra</div>
                            <?php endif; ?>

                            <p class="mt-4 text-sm font-semibold text-slate-700 text-center line-clamp-2"><?php echo e($partner->name); ?></p>

                            <?php if(!empty($partner->website_url)): ?>
                                <a href="<?php echo e($partner->website_url); ?>" target="_blank" rel="noopener noreferrer" class="mt-2 text-xs font-semibold text-green-700 hover:text-green-800">
                                    Kunjungi situs
                                </a>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Magang\PT. YMP\fundunity\resources\views\landing\partners.blade.php ENDPATH**/ ?>