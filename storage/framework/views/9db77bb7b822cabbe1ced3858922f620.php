...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo e(!empty($siteSettings['site_name']) ? $siteSettings['site_name'] : 'FundUnity'); ?> Admin">
    ...
    <style>
        :root {
            <?php $__currentLoopData = $activeTheme; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shade => $rgb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            --color-admin-<?php echo e($shade); ?>: <?php echo e($rgb); ?>;
...
<?php /**PATH C:\kuliah\lain lain\Magang\YMP\iniraden_fundunity\resources\views/layouts/admin/app.blade.php ENDPATH**/ ?>