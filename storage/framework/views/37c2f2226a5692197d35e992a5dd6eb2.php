...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.modal','data' => ['id' => 'partnerModal','title' => 'Tambah Mitra','maxWidth' => 'max-w-lg','headerColor' => 'bg-admin-600','closeButtonId' => 'closePartnerModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'partnerModal','title' => 'Tambah Mitra','maxWidth' => 'max-w-lg','headerColor' => 'bg-admin-600','closeButtonId' => 'closePartnerModal']); ?>
