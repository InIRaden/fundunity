<?php
    ...
    $phoneForWa = preg_replace('/[^0-9]/', '', $siteSettings['phone'] ?? '');
    if (str_starts_with($phoneForWa, '0')) {
        $phoneForWa = '62' . substr($phoneForWa, 1);
    }
    $whatsappApiUrl = $phoneForWa ? "https://wa.me/{$phoneForWa}" : ($siteSettings['whatsapp_url'] ?? '#');
?>
...
<?php endif; ?>
                    <span class="font-black tracking-tight text-2xl text-white"><?php echo e($brandName); ?></span>
                </div>
                ...
                <div class="flex space-x-4">
                    <a href="<?php echo e($siteSettings['instagram_url'] ?? '#'); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-emerald-900/50 flex items-center justify-center text-orange-400 hover:bg-orange-500 hover:text-white transition-all">
                    ...
                    <a href="<?php echo e($whatsappApiUrl); ?>" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-emerald-900/50 flex items-center justify-center text-orange-400 hover:bg-orange-500 hover:text-white transition-all">
            ...
            <div class="md:col-span-2">
                <h4 class="text-white font-bold mb-6 text-sm">Organisasi</h4>
                <ul class="space-y-4">
            ...
            <div class="md:col-span-3">
                <h4 class="text-white font-bold mb-6 text-sm">Hubungi Kami</h4>
                <ul class="space-y-4">
            ...
            <div class="md:col-span-3">
                <h4 class="text-white font-bold mb-6 text-sm">Newsletter</h4>
                ...
                <form id="newsletterForm" method="POST" action="<?php echo e(route('newsletter.subscribe')); ?>" class="relative">
                    ...
                    <input
                        ...
                        class="w-full bg-emerald-900/20 border border-emerald-800 rounded-xl py-3 pl-4 pr-12 text-white outline-none focus:border-orange-500 transition-colors"
                        required
                    >
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.paper-plane','data' => ['id' => 'newsletterSubmitIcon','class' => 'h-5 w-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'newsletterSubmitIcon','class' => 'h-5 w-5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\coding\fundunity\resources\views/components/landing/footer.blade.php ENDPATH**/ ?>