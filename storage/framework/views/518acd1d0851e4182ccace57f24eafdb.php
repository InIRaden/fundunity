    ...
    <div class="max-w-4xl mx-auto px-6 -mt-12 relative z-20">
        <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 p-8 md:p-12 border border-slate-100">
            ...
            <div class="max-w-none mb-12">
                <?php
                    // Simple parser for "1. Title\nContent" blocks
                    $blocks = preg_split('/\n\s*\n/', $content ?? 'Belum ada kebijakan privasi yang diatur.');
                    $itemIndex = 1;
                ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\coding\intern yukmari\fundunity\resources\views/landing/privacy.blade.php ENDPATH**/ ?>