...
<script>
  ...
  const partnerStoreUrl = <?php echo json_encode(route('admin.partners.store'), 15, 512) ?>;
  const partnerBaseUrl = <?php echo json_encode(url('/admin/partners'), 15, 512) ?>;
  ...
  const partnerState = {
    data: (<?php echo json_encode($partners, 15, 512) ?> || []).map((item) => normalizePartner(item)),
    search: '',
    editingId: null,
    deletingId: null,
    isSubmitting: false,
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\coding\intern yukmari\fundunity\resources\views/admin/partners.blade.php ENDPATH**/ ?>