    ...
    <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <a href="<?php echo e(route($tab['route'])); ?>" class="flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold transition-all text-slate-500 hover:bg-slate-50 hover:text-slate-900">
        <span class="inline-flex items-center">
          <i class="<?php echo e($tab['key'] === 'slider' ? 'ph ph-slideshow' : ($tab['key'] === 'focus' ? 'ph ph-crosshair' : ($tab['key'] === 'about' ? 'ph ph-users-four' : ($tab['key'] === 'faqs' ? 'ph ph-chats-circle' : 'ph ph-handshake')))); ?> text-sm"></i>
        </span>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\kuliah\lain lain\Magang\YMP\iniraden_fundunity\resources\views/admin/landing-manager.blade.php ENDPATH**/ ?>