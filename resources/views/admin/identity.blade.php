  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div class="lg:col-span-1 space-y-6">
      <div class="bg-white rounded-2xl shadow-xl border border-slate-100 p-8 flex flex-col items-center text-center">
        ...
        <h2 class="text-lg font-bold text-slate-900 leading-tight">{{ $identity['orgName'] }}</h2>
        <p class="text-sm text-slate-400 mt-1 font-medium">{{ $identity['shortName'] }}</p>
        ...
        <div class="mt-8 pt-8 border-t border-slate-100 w-full">
          ...
          <div class="bg-emerald-600 rounded-xl p-4 flex items-center gap-3 text-left">
            ...
            <span class="text-xs font-bold text-white truncate">{{ $identity['shortName'] }}</span>
          </div>
        </div>
      </div>
        ...
        <div class="p-8 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-2">
              ...
              <input type="text" value="{{ $identity['orgName'] }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-400" />
            </div>
            <div class="space-y-2">
              <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider">Nama Pendek</label>
              <input type="text" value="{{ $identity['shortName'] }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-400" />
            </div>
          </div>

          <div class="space-y-2">
            <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider">Tagline Utama</label>
            <input type="text" value="{{ $identity['tagline'] }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-400" />
          </div>
        </div>
        ...
        <div class="p-8 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-2">
              ...
              <input type="email" value="{{ $identity['email'] }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-400" />
            </div>
            <div class="space-y-2">
              <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider">WhatsApp/Telepon</label>
              <input type="text" value="{{ $identity['phone'] }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-400" />
            </div>
            <div class="space-y-2">
              <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider">Instagram Username</label>
              <input type="text" value="{{ $identity['instagram'] }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-400" />
            </div>
            <div class="space-y-2">
              <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider">Alamat / Sekretariat</label>
              <input type="text" value="{{ $identity['address'] }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-400" />
            </div>
          </div>
