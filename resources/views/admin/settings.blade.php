        ...
        <div id="menuPane" class="hidden setting-pane space-y-8 animate-fade-in">
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-2 pb-2 border-b border-slate-100">
              <i class="ph ph-sidebar text-emerald-600 text-[18px]"></i>
          ...
          <div class="space-y-4 pt-4 border-t border-slate-100">
            <div class="flex items-center gap-2 pb-2 border-b border-slate-100">
              <i class="ph ph-browser text-emerald-600 text-[18px]"></i>
          ...
          <div class="flex justify-end pt-4 border-t border-slate-100">
            <button type="button" id="saveMenuBtn" class="px-6 py-2.5 bg-emerald-600 text-white rounded-xl text-sm font-bold hover:bg-emerald-700 flex items-center gap-1.5"><i class="ph ph-floppy-disk text-base"></i> Simpan Pengaturan Menu</button>
          </div>
        </div>
      </div>
    </div>
