...
<footer class="bg-[#022c22] border-t border-emerald-900/50 text-slate-400 py-16">
    <div class="max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
            <div class="md:col-span-4">
                ...
                <p class="mb-6 leading-relaxed text-emerald-50/50">
                    {{ $siteSettings['footer_tagline'] ?? 'Platform konektivitas, galang dana, dan transparansi organisasi terpercaya. Bersama memberdayakan masyarakat dan mencetak dampak positif setiap harinya.' }}
                </p>
                <div class="flex space-x-4">
                    <a href="{{ $siteSettings['instagram_url'] ?? '#' }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-emerald-900/50 flex items-center justify-center text-orange-400 hover:bg-orange-500 hover:text-white transition-all">
                    ...
                    <a href="{{ $whatsappApiUrl }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-emerald-900/50 flex items-center justify-center text-orange-400 hover:bg-orange-500 hover:text-white transition-all">
            ...
            <div class="md:col-span-3">
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <span>{{ $siteSettings['email'] ?? 'hmt@unpad.ac.id' }}</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
            <p>&copy; {{ date('Y') }} {{ $siteSettings['footer_copyright'] ?? 'HMT-Unpad. All rights reserved.' }}</p>
