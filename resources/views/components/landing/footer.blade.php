        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
            <div class="md:col-span-4">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="{{ $siteSettings['whatsapp_url'] ?? '#' }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-emerald-900/50 flex items-center justify-center text-orange-400 hover:bg-orange-500 hover:text-white transition-all">
