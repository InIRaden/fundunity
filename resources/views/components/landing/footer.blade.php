        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
            <div class="md:col-span-4">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="font-black tracking-tight text-2xl text-white">{{ $brandName }}<span class="text-emerald-500">{{ $brandSuffix }}</span></span>
                </div>
                ...
                <div class="flex space-x-4">
                    <a href="{{ $siteSettings['instagram_url'] ?? '#' }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-emerald-400 hover:bg-emerald-500 hover:text-white transition-all">
                    ...
                    <a href="{{ $siteSettings['whatsapp_url'] ?? '#' }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-emerald-400 hover:bg-emerald-500 hover:text-white transition-all">
