...
<head>
    ...
    <title>Anda Sedang Offline - {{ $siteSettings['site_name'] ?? 'FundUnity' }}</title>
...
<body>
    <div class="container">
        <div class="logo">
            <img src="{{ !empty($siteSettings['site_logo']) ? $siteSettings['site_logo'] : '/images/Logo.png' }}" alt="{{ $siteSettings['site_short_name'] ?? 'FundUnity' }}">
        </div>
